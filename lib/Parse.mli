...
(**
    Functions for parsing powershell programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a powershell program from a string into a typed OCaml CST.
...
(** Parse a powershell program from a file into a typed OCaml CST.
