/*
  Generated by ocaml-tree-sitter for powershell.
*/
...
// OCaml function
CAMLprim value octs_create_parser_powershell(value unit) {
  CAMLparam0();
  CAMLlocal1(v);
  ...
  ts_parser_set_language(parser, tree_sitter_powershell());
  CAMLreturn(v);
};
